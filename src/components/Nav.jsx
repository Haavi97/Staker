    ...
    <>
       <div className="hidden md:block">
            ...
            <Link to ="#"
              ...
              <button className='rounded-full bg-pink-400 border-2 border-white shadow-xl transition-all duration-300 hover:shadow-xl text-white px-4 hover:bg-white hover:text-black'>
                <Link>Register</Link>
              </button>
            </div>
          </div>
